...
<p align="center">
  <img src="https://img.shields.io/badge/Version-v1.3.1_develop-blue" alt="Version">
...
| v1.3.1 | 模块化 Code Template (产流/汇流模块组合) | 2025-05-04 |
...
| 模块 | 说明 | 适用场景 |
|------|------|----------|
| `scs_runoff` | SCS-CN 产流 | 干旱小流域 |
| `xaj_runoff` | 新安江蓄满产流 | 湿润区、南方流域 |
| `tank_runoff` | Tank 产流 | 复杂流域、多重响应 |
| `hbv_runoff` | HBV 土壤水分 | 温带、寒带流域 |
| `simple_runoff` | 简单产流 | 概念性模拟 |

### 汇流模块 (Routing Modules)

| 模块 | 说明 | 适用场景 |
|------|------|----------|
| `linear_routing` | 线性水库 | 慢速响应 |
| `nonlinear_routing` | 非线性水库 | 非线性响应 |
| `nash_routing` | Nash 单位线 | 汇流延迟 |
| `direct_routing` | 直接汇流 | 快速响应 |

### 防雷设计

1. **参数命名空间隔离**: 产流参数 `*_runoff`，汇流参数 `*_routing`
2. **状态初始化映射**: 每个模块定义自己的 `state_init_mapping`
